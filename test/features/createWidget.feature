Feature: Create new wdiget
    ...
    --And   the page will show the available widgets to create
    --When  the user clicks on the widget 
    --Then  the page will add the widget on the dashboard
    --When  the user interact with the added widget 
    --Then  the updates will shown on the widget 